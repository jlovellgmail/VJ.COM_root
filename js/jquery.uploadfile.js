...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        function createProgressDiv(obj, s) {
			...
			this.errMsg = $("<span style='color:red;'></span>").appendTo(this.statusbar).hide();
			...
			this.closeBtn = $("<div class='ajax-file-upload-red'>Close</div>").appendTo(this.statusbar).hide();
                ...
                error: function (xhr, status, errMsg) {
                    ...
                    if (xhr.statusText == "abort") //we aborted it
                    {
                        ...
                        if (s.showStatusAfterError) {
                            pd.progressDiv.hide();
							pd.errMsg.append("ERROR: " + errMsg);
							pd.errMsg.show();
							pd.closeBtn.show();
							pd.closeBtn.click(function () {
                                pd.statusbar.hide("slow");
                                pd.statusbar.remove();
                            });                            
                        } else {
