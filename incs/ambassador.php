...
$posts = $ambassador->getAmbPublishedPosts();
...
<div class='landing-hero-wrapper' style='margin-bottom: 0;'>
    <div class='block rel'>
        ...
        <div class='aspect-img aspect-img-hero ambProfileHeroWrapper' style="background-image: linear-gradient(rgba(0,0,0,0.35), rgba(0,0,0,0.4)), url('<?php echo $HeroImg; ?>'); <?php echo $AlignHero; ?>">
            <div class="widthWrapper tableWrapper h100p amb-landing-title-tr">
                <div class="cellWrapper">
                    <div class="lg-twelve heroText">
                        <h1 class="caps fw-600 size4" style="letter-spacing: 2px;"><?php echo $Name; ?></h1>
                        <h2 class="ital fw-400 size5"><?php echo $LocationTxt; ?></h2>
                    </div>
                </div>
            </div>
        </div>
...
<div class="bgWrapper ambProfileBgWrapper">
    ...
    <div class="widthWrapper">
        ...
        <div class="row ambIntroRow">
            <div class="xs-ten md-eight lg-four ambAvatarWrapper">
                <div class='amb-event-left-col-margin hide'></div>
                <div class="ambAvatar leafShadow">
                ...
                <div class="ambIntroP textLeft">
                    ...
                    <button type="button" class="ambQuestionsBtn2 ambQuestionFn ital fw-300 size5" data-id="showReadMore">More About <?php echo $FName; ?></button>
                </div>
                    ...
                    <div>
                        ...
                        if (is_array($events)) {
                            foreach ($events as $row) {
								...
								$eventUrlSEO = 'http://www.virgiljames.net/incs/modals/modalAmbEvent.php?EID=' . $event->getVar("EID"). '&AmbID='. $AID;
                                ?>
                                <div class='event-block rel block'>
                                    <a href="javascript:void(0);" class='event-expand event-details' onclick="showModal('/incs/modals/modalAmbEvent.php?EID=<?php echo $event->getVar("EID"); ?>&AmbID=<?php echo $AID; ?>');">
                                        ...
                                        </div><div class='event-list-text xs-twelve sm-ten' style='padding-top: 2px;'>
...
<?php } ?>
        ...
        <!-- <style>.ambIntroRow .scroll-arrow-indicator i::before { line-height: 24px; height: 24px; }</style>
            <div class="scroll-arrow-indicator index-scroll-1" style='bottom: 0'><i style="position: relative; display: block; color: #000; text-shadow: none; line-height: 24px; height: 24px; overflow:hidden;" id="arrow-01" class="icon-angle-down"></i></div> -->
        </div>
...
<div class='widthWrapper'>
    <div class='rel block' style='margin: auto; width: 100%; margin-bottom: 30px;'>
        ...
        <div class="journalHighlightsHead textCenter">
            <!-- <div class="line-separator50px marBottom10 bgContrastGrey"></div> -->
            <!-- <h3 class="ital fw-300">Here Are a Few of My</h3> -->
            <h2 class="ital fw-300 size45">A Few of My Favorite Things</h2>
            ...
            <?php
                foreach ($inspirations as $inspiration) {
                    ...
                    ?><div class='grid-item <?php echo $cssWrapper; ?>'>
                			...
                			<a href="javascript:void(0);" onclick="showModal('/incs/modals/inspirationModal.php?IID=<?php echo $IID; ?>');" class='grid-item-content <?php echo $cssContent; ?>' style='background-image: url(<?php echo $imgUrl; ?>)'>
                			</a>
            			</div><?php
                						} ?>
        </div>
                ...
                foreach ($posts as $row) {
                    ...
                    --><div class='ambJournalPost <?php echo $divClass1; ?>'>
                        <div class="highlightArticle">
                            <div class="highlightThumbWrapper sm-five md-four lg-three <?php echo $divClass2; ?>"><a href="/post-view.php?from=ambassador&PermLink=<?php echo $PermLink; ?>&Title=<?php echo $urlTitle; ?>&PID=<?php echo $PID; ?>"><img class="highlightThumb" src="<?php echo $ImgUrl; ?>" alt="<?php echo $Title; ?>" /></a></div><!-- 
                            --><div class="highlightCopy sm-seven md-eight lg-nine xl-eight">
                                <a href="/post-view.php?from=ambassador&PermLink=<?php echo $PermLink; ?>&Title=<?php echo $urlTitle; ?>&PID=<?php echo $PID; ?>"><h4 class='fw-600 size5'><?php echo $Title; ?></h4></a>
                                <p class='truncated-post' data-truncate-lines="3"><?php echo $SubTitle; ?></p><a href="/post-view.php?from=ambassador&PermLink=<?php echo $PermLink; ?>&Title=<?php echo $urlTitle; ?>&PID=<?php echo $PID; ?>" class="fw-600 size7">Read More &#43;</a>
                                <!-- <div class="infoRow">
...
*/ ?>
        ...
        <script>
            $('.ambQuestionsBtn').click(function () {
                $('html, body').animate({
                    scrollTop: ($('#qCloseAnchor').offset().top)
                },750);
            })
        </script>
