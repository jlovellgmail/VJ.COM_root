...
$list = $AmbassadorInspiration->getRelatedProducts();
    ...
    <div class='row textLeft generalForm'>
        <form class='img-grid-prod-select-form'>
            ...
            foreach ($products as $product) {
                ...
                --><?php }
            ?>
            <button type="button" onclick="updateRelatedProducts('<?php echo $IID; ?>')" class="admin-add-button marTop15">Update</button>
        </form>
    </div>
</div>